...
class SamosaAdapter(var context: Context, var products: List<Product> = arrayListOf()) :
        RecyclerView.Adapter<SamosaAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        (context as ActivitySamosa).coordinator
    }
...
//                ShoppingCart.addItem(item)
            ...
            Observable.create(ObservableOnSubscribe<MutableList<CartItem>> {
                ...
                itemView.addToCart.setOnClickListener { view ->
                    ...
                    //notfy users
                    Snackbar.make(
                            (itemView.context as ActivitySamosa).coordinator,
                ...
                (itemView.context as ActivitySamosa).cart_size_samosa.text = quantity.toString()
