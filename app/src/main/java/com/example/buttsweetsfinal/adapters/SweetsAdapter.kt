...
import com.example.buttsweetsfinal.ActivitySweets
...
class SweetsAdapter(var context: Context, var products: List<Product> = arrayListOf()) :
        RecyclerView.Adapter<SweetsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        (context as ActivitySweets).coordinator
    }
...
//                ShoppingCart.addItem(item)
            ...
            Observable.create(ObservableOnSubscribe<MutableList<CartItem>> {
                ...
                itemView.addToCart.setOnClickListener { view ->
                    ...
                    //notfy users
                    Snackbar.make(
                            (itemView.context as ActivitySweets).coordinator,
                ...
                (itemView.context as ActivitySweets).cart_size_sweets.text = quantity.toString()
